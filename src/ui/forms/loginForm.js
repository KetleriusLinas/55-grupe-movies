            ...
            <div class="row">
                <form class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
                    <div class="mb-4">
                        ...
                        <input value="${email}" id="username_or_email" type="text" class="form-control" required>
                    </div>
                    <div class="mb-4">
                        <label for="password">Password</label>
                        <input value="${password}" id="password" type="password" class="form-control" required>
                    </div>
                    <div class="mb-4">
